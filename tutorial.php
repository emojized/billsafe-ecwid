 ...
 */
ini_set('include_path', ini_get('include_path') . PATH_SEPARATOR . 'localhost/billsafe/');
...
$bs->setCredentials(array(
    'merchantId'             => '48184',
    'merchantLicenseSandbox' => 'b209af54da6e75c4d7bd0082c822c0c3',
    'merchantLicenseLive'    => 'b209af54da6e75c4d7bd0082c822c0c3',
    'applicationSignature'   => 'ecd220ae0c37aa684c1ca98625dfc098',
...
$params = array(
    ...
    'order_currencyCode'        => $_POST['order_currencyCode'],
    ...
    'customer_postcode'         => $_POST['customer_zip'],
    ...
    'articleList_0_name'        => $_POST['product_name'],
    'articleList_0_description' => '',
    'articleList_0_type'        => 'goods',
    'articleList_0_quantity'    => $_POST['product_quantity'],
    'articleList_0_netPrice'    => $_POST['product_grossPrice'],
